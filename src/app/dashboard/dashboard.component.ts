...
export class DashboardComponent implements OnInit {
  ...
  constructor(private placeOrderService: PlaceOrderServiceService, private itemService: ItemService, private orderService: OrderService) { }
  ...
  getAllRoundAmountTotal(): void {
    this.orderService.getTotalAmountForToday().subscribe(
      (result) => {
  ...
  getAllAmountForCashTotal(): void {
    this.orderService.getTotalAmountForPaymentTypeToday('Cash').subscribe(
      (result) => {
  ...
  getAllAmountForEcoCashTotal(): void {
    this.orderService.getTotalAmountForPaymentTypeToday('EcoCash').subscribe(
      (result) => {
  ...
  getAllAmountForSwipeTotal(): void {
    this.orderService.getTotalAmountForPaymentTypeToday('Swipe').subscribe(
      (result) => {
