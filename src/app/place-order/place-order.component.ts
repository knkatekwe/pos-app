...
export class PlaceOrderComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  qtyF = new FormControl(0);
  qtyOHF = new FormControl();
  rate = new FormControl();
  tenderedAmount = new FormControl(0);
  ...
  ngOnInit() {
    ...
    // this.tendered = this.tenderedAmount.valueChanges.subscribe((res)=>{
    // 	console.log(res)
    // })
  }

  onTenderChange(value) {
    console.log("..........................................." + value);
    // this.change = this.tenderedAmount.value - this.fullTotal
  }
  ...
  SelectOrderDetails() {
    ...
    if (this.qtyF.value === 0) {
      this.confirmationModalService.confirm(
        "Sale",
        "Enter number greater than 0 for the product!",
        "Ok"
      );
    ...
    if (this.saleType.value === "RETAIL") {
      console.log("this sale is:" + this.saleType.value);
      this.orderDetail.unitprice =
        this.searchedItems.unicPrice * this.rate.value; //
    } else {
      console.log("this sale is:" + this.saleType.value);
      this.orderDetail.unitprice =
        this.searchedItems.retailPrice * this.rate.value; //
    }
  ...
  searchPaymentType(event: any) {
    this.paymentTypeService
      .searchPaymentType(event.target.value)
      .subscribe((result) => {
  ...
  addOrder() {
    ...
    this.orders = new Orders(
      this.fullTotal,
      this.tenderedAmount.value,
      this.tenderedAmount.value - this.fullTotal,
      this.searchedPaymentTypes,
      this.saleType.value
    );
