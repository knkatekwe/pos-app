...
export class ItemsComponent implements OnInit {
	...
	saveItems() {
		...
		this.itemService.saveItems(this.selectedItems).subscribe((result) => {
			if (result) {
	...
	deletItems(itemsID: Items){
		if (confirm('Are you sure you want to delete this product?')) {
			this.itemService.deletePaymentType(itemsID.code).subscribe((result) => {
				if (result) {
